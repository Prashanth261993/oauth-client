...
Article.create! name: "Batman", author: "Bruce Wayne", published_at: 2.weeks.ago, content: <<-ARTICLE
...
Article.create! name: "Superman", author: "Clark Kent", published_at: 3.weeks.ago, content: <<-ARTICLE
...
Article.create! name: "Krypton", author: "Clark Kent", published_at: 5.weeks.ago, content: <<-ARTICLE
...
Article.create! name: "Lex Luthor", author: "Clark Kent", published_at: 7.weeks.ago, content: <<-ARTICLE
...
Article.create! name: "Robin", author: "Bruce Wayne", published_at: 6.weeks.ago, content: <<-ARTICLE
